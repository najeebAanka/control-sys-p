            ...
            <form action="#" method="POST" id="edit_judge_group_form" enctype="multipart/form-data">
                ...
                <div class="modal-body p-4 bg-light">
                    ...
                    <div class="my-2">
                        ...
                        <hr />
                        <button type="button" id="check-judges-list-btn" class="btn btn-info">Check judges
                            status</button>
                    </div>

                    <div class="judges-list">

                        <?php foreach (\App\Models\User::orderBy('name' ,'asc')->where('user_type' ,0)->get() as $c){ ?>
                        <input type="checkbox" name="judges[]" class="judge-box" id="box{{ $c->id }}"
                            value="{{ $c->id }}" /> {{ $c->name }}
                        <hr />
                        <?php } ?>
                        ...
                        <div class="col-lg-12">
                            <div class="card shadow">
                                <div class="card-header d-flex justify-content-between align-items-center">
                                    <h3>Manage Competition Classes</h3>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.status == 200) {
                            ...
                            $("#edit_judges_group_btn").text('Update');
