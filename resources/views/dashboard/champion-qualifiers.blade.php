...
<html lang="en">
        ...
        <div class="row">
            ...
            <div class="container">
                ...
                <div style="padding: 1rem;">
                    ...
                    <div class="ss-gh" style="border: solid 1px #ccc;
                         background-color: #fff;
    padding: 1rem;
    margin-bottom: 5rem;">
    ...
    font-size: 1.3rem;">
                            ...
                            <a class="btn btn-success btn-sm no-print" style="float: right;" target="blank" href="{{url('dashboard/champion-qualifiers/'.$c->id."/". $cmp_id)}}">Print List</a>
                          <b>  {{$c->name_en}} </b>  
                        </div> 
                            <br />
